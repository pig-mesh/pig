<#assign content>
    <div class="mb-8 text-center">
        <svg class="w-16 h-16 mx-auto mb-4 text-purple-600 dark:text-purple-400" viewBox="0 0 24 24" fill="none"
            ...
            <path d="M17.6972 19.7C16.0993 18.0307 14.125 17 12 17C9.87499 17 7.90072 18.0307 6.30283 19.7"
    ...
    <script>
        (() => {
            ...
            const showCaptcha = <#if showCaptcha?? && showCaptcha>true<#else>false</#if>;
            ...
            function syncCaptcha() {
                ...
                codeInput.required = showCaptcha;
