...
public class JobLogController {
	...
	public Map<String, Object> pageList(HttpServletRequest request,
			...
			@RequestParam("jobGroup") int jobGroup, @RequestParam("jobId") int jobId,
			@RequestParam("logStatus") int logStatus, @RequestParam("filterTime") String filterTime) {
	...
	@ResponseBody
	public ReturnT<String> clearLog(HttpServletRequest request, @RequestParam("jobGroup") int jobGroup,
			@RequestParam("jobId") int jobId, @RequestParam("type") int type) {
		// valid permission
