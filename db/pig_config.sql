...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='config_info';
...
CREATE TABLE `permissions` (
                               `role` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
                               `resource` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
                               `action` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `roles` (
                         `username` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
                         `role` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `users` (
                         `username` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
                         `password` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
