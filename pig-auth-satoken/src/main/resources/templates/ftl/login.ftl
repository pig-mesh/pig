	...
	<div class="flex justify-center self-center  z-10">
		<div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
			...
			<form class="form-signin" action="/token/form" method="post">
				<input type="hidden" name="client_id" class="form-control" value="${req.getParam('client_id')}" placeholder="所属客户端">
				<input type="hidden" name="response_type" class="form-control" value="${req.getParam('response_type')}" placeholder="所属客户端">
				<input type="hidden" name="redirect_uri" class="form-control" value="${req.getParam('redirect_uri')}" placeholder="所属客户端">
				<input type="hidden" name="scope" class="form-control" value="${req.getParam('scope')}" placeholder="所属客户端">
				<input type="hidden" name="state" class="form-control" value="${req.getParam('state')!}" placeholder="所属客户端">
				<div class="space-y-6">
					<div class="">
