...
/**
 * import java.time.ZoneId; import java.util.Locale; import java.util.TimeZone;
 *
 * import org.springframework.boot.autoconfigure.AutoConfiguration; import
 * org.springframework.boot.autoconfigure.AutoConfigureBefore; import
 ...
 *
 * import cn.hutool.core.date.DatePattern; import tools.jackson.databind.ObjectMapper;
...
/**
 * @AutoConfiguration
 * @ConditionalOnClass(ObjectMapper.class) @AutoConfigureBefore(JacksonAutoConfiguration.class)
