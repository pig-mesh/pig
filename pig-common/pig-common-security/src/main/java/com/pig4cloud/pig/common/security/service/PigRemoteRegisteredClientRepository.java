...
public class PigRemoteRegisteredClientRepository implements RegisteredClientRepository {
	...
	public RegisteredClient findByClientId(String clientId) {
		...
		if (Objects.isNull(clientDetails)) {
			SysOauthClientDetails fetchedClientDetails = RetOps.of(clientDetailsService.getClientDetailsById(clientId))
				.getData()
		...
		return builder.tokenSettings(TokenSettings.builder()
			...
			.accessTokenTimeToLive(Duration.ofSeconds(Optional.ofNullable(finalClientDetails.getAccessTokenValidity())
