...
import com.pig4cloud.pigx.auth.support.filter.AuthSecurityConfigProperties;
...
public class PigxDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	 ...
	 * @see PigxUserDetailsService#support(String, String)
	 * @see TenantContextHolder#setTenantId(Long)
	 */
	@SneakyThrows
	@Override
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		try {
			...
			else if (loadedUser instanceof PigxUser pigxUser && Objects.nonNull(pigxUser.getTenantId())) {
				TenantContextHolder.setTenantId(pigxUser.getTenantId());
			}
			return loadedUser;
		}
